...
from . import window_height, window_width, current_file_path, current_date
...
class ThirdScreen(Screen):
    def __init__(self, **kwargs):
        ...
        #抬头部分
        layoutPart1=BoxLayout(orientation='horizontal', size_hint=(1, 0.1),pos_hint={'x':0,'y':0.9})
        ...
        layoutPart2=BoxLayout(orientation='vertical', size_hint=(1, 0.8),pos_hint={'x':0,'y':0.1})
        layoutPart2_0=BoxLayout(size_hint=(1,0.05),pos_hint={"x":0,"y":0.95})
        label_website=Label(text="鼓楼医院课程网站(Seatable)", font_size="10sp", font_name='chinese_font',halign="left",text_size=(window_width,None))
        ...
        layoutPart2_1=BoxLayout(size_hint=(1,0.05),pos_hint={"x":0,"y":0.75})
        label_university=Label(text="大学名称(南京大学, 徐州医科大学, 南京医科大学...)",font_size="10sp", halign="left" , font_name='chinese_font',text_size=(window_width,None))
        ...
        layoutPart2_2=BoxLayout(size_hint=(1,0.05),pos_hint={"x":0,"y":0.55})
        label_university=Label(text="年级与班级(注意表格内写的是什么, 区分\"2021临床医学\"与\"2021级临床医学\")",halign="left",font_size="10sp", font_name='chinese_font',text_size=(window_width,None))
        ...
        layoutPart2_n=BoxLayout(size_hint=(1,0.4),pos_hint={"x":0,"y":0})
